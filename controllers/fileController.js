...
class FileController {
    ...
    async dowloadFile(req, res) {
        try {
            ...
            console.log(error);
            res.status.json({ message: "download error" });
        }
    }
    ...
    async uploadProfileAvatar(req, res) {
        try {
            ...
            console.log(error);
            return res.status(400).json({ message: "Upload profile avatar error" });
        }
    }

    async deleteProfileAvatar(req, res) {
        try {
            const user = await User.findById(req.user.id);
            ...
            console.log(error);
            return res.status(400).json({ message: "Delete profile avatar error" });
        }
    }
}
